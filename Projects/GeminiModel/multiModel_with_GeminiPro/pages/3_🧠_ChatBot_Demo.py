...
st.write(
    ...
    1] **:green[Upload Document]**: Upload all your documents you need to query. Click on submit button to process those document.
    
    Main Page:
    
    2] **:red[Query your doc]**: Ask context specific question to the agent and view the response.
